...
class EnrollmentViewSet(ViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        for a user, and it would be difficule to aggregate such a list for several disparate LMS,
        ...
        if not request.query_params.get("course_run_id"):
            return Response(
                status=400,
                data={"errors": [_('The "course_run_id" parameter is mandatory.')]},
            )
